	...
	return (
		<motion.div
			...
			<h5 className="my-3 font-medium dark:text-white">
				...
				Diploma in Computer Science from St.Paul&apos;s University, Kenya.
			</h5>
			<div
				className="flex-grow p-4 mt-5 bg-gray-400 dark:bg-dark-100"
				style={{ marginLeft: "-1.5rem", marginRight: "-1.5rem" }}>
				<h6 className="my-3 text-xl font-bold tracking-wide dark:text-white">
					What I Offer
				</h6>
				<motion.div
					variants={stagger}
					...
					{services.map((service) => (
						<motion.div
							variants={fadeInUp}
							key=""
							className="bg-gray-200 rounded-lg lg:col-span-1 dark:bg-dark-200 dark:text-white">
